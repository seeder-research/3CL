...
func golden_fft4(dataIn []float32, N int) []float32 {
	arr := dataIn
	...
	for i := 0; i < N; i++ {
		...
		out_arr[idx] = in0_r + in1_r + in2_r + in3_r
		out_arr[idx+1] = in0_i + in1_i + in2_i + in3_i
		out_arr[idx+2*N]   = in0_r + in1_i - in2_r - in3_i
		out_arr[idx+2*N+1] = in0_i - in1_r - in2_i + in3_r
		out_arr[idx+4*N]   = in0_r - in1_r + in2_r - in3_r
		out_arr[idx+4*N+1] = in0_i - in1_i + in2_i - in3_i
		out_arr[idx+6*N]   = in0_r - in1_i - in2_r + in3_i
		out_arr[idx+6*N+1] = in0_i + in1_r - in2_i - in3_r
	}
	return out_arr
}
...
func main() {
	...
	kernelObj := kernels["fft4_c2c_long_interleaved_oop"]
	...
	fmt.Printf("Begin first run of fft4_c2c_long_interleaved_oop kernel... \n");
	...
	if err := kernelObj.SetArgs(input, output, uint32(testSz/8), uint32(1), uint32(4)); err != nil {
	...
	fmt.Printf("First run of fft4_c2c_long_interleaved_oop kernel completed and starting inverse to check... \n");

	kernelObj1 := kernels["ifft4_c2c_long_interleaved_oop"]
	...
	if err = kernelObj1.SetArgs(output, rev_in, uint32(testSz/8), uint32(1), uint32(4)); err != nil {
		fmt.Printf("SetKernelArgs failed: %+v \n", err)
		return
	}
	...
	fmt.Printf("Begin first run of ifft4_c2c_long_interleaved_oop kernel... \n");
	...
	fmt.Printf("Finished tests on fft4_c2c_long_interleaved_oop\n")
