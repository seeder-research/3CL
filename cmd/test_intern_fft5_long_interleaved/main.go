...
func golden_fft5(dataIn []float32, N int) []float32 {
	arr := dataIn
	...
	for i := 0; i < N; i++ {
		...
		out_arr[idx] = in0_r + in1_r + in2_r + in3_r + in4_r
		out_arr[idx+1] = in0_i + in1_i + in2_i + in3_i + in4_i
		out_arr[idx+2*N]   = in0_r + (cs1*in1_r + sn1*in1_i) + (cs2*in2_r + sn2*in2_i) + (cs2*in3_r - sn2*in3_i) + (cs1*in4_r - sn1*in4_i)
		out_arr[idx+2*N+1] = in0_i + (cs1*in1_i - sn1*in1_r) + (cs2*in2_i - sn2*in2_r) + (cs2*in3_i + sn2*in3_r) + (cs1*in4_i + sn1*in4_r)
		out_arr[idx+4*N]   = in0_r + (cs2*in1_r + sn2*in1_i) + (cs1*in2_r - sn1*in2_i) + (cs1*in3_r + sn1*in3_i) + (cs2*in4_r - sn2*in4_i)
		out_arr[idx+4*N+1] = in0_i + (cs2*in1_i - sn2*in1_r) + (cs1*in2_i + sn1*in2_r) + (cs1*in3_i - sn1*in3_r) + (cs2*in4_i + sn2*in4_r)
		out_arr[idx+6*N]   = in0_r + (cs2*in1_r - sn2*in1_i) + (cs1*in2_r + sn1*in2_i) + (cs1*in3_r - sn1*in3_i) + (cs2*in4_r + sn2*in4_i)
		out_arr[idx+6*N+1] = in0_i + (cs2*in1_i + sn2*in1_r) + (cs1*in2_i - sn1*in2_r) + (cs1*in3_i + sn1*in3_r) + (cs2*in4_i - sn2*in4_r)
		out_arr[idx+8*N]   = in0_r + (cs1*in1_r - sn1*in1_i) + (cs2*in2_r - sn2*in2_i) + (cs2*in3_r + sn2*in3_i) + (cs1*in4_r + sn1*in4_i)
		out_arr[idx+8*N+1] = in0_i + (cs1*in1_i + sn1*in1_r) + (cs2*in2_i + sn2*in2_r) + (cs2*in3_i - sn2*in3_r) + (cs1*in4_i - sn1*in4_r)
	}
	return out_arr
}
...
func main() {
	...
	kernelObj := kernels["fft5_c2c_long_interleaved_oop"]
	...
	fmt.Printf("Begin first run of fft5_c2c_long_interleaved_oop kernel... \n");
	...
	fmt.Printf("First run of fft5_c2c_long_interleaved_oop kernel completed and starting inverse to check... \n");

	kernelObj1 := kernels["ifft5_c2c_long_interleaved_oop"]
	...
	fmt.Printf("Begin first run of ifft5_c2c_long_interleaved_oop kernel... \n");
	...
	fmt.Printf("cs1= %25.24g\n", float64(math.Cos(2.0*math.Pi/5.0)))
	fmt.Printf("sn1= %25.24g\n", float64(math.Sin(2.0*math.Pi/5.0)))
	fmt.Printf("cs2= %25.24g\n", float64(math.Cos(4.0*math.Pi/5.0)))
	fmt.Printf("sn2= %25.24g\n", float64(math.Sin(4.0*math.Pi/5.0)))
